...
\begin{enumerate}
  \item la proportion de prédictions correctes \emph{sur des observations qui
        n'ont pas servi à la construire} ;
  \item la comparaison de cette proportion à celle d'une règle triviale ;
  \item la répartition des erreurs restantes, que le taux global agrège.
\end{enumerate}
