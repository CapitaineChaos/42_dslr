...
\begin{lecture}
Le modèle annonce une probabilité pour chaque élève. Le fichier, lui, donne la
réponse. Un bon jeu de coefficients est celui sous lequel les réponses observées
étaient les plus probables. Ce critère s'écrit, se transforme en somme, et
...
\section{Du maximum à un minimum}
