...
modèle annonce et ce qui est observé. Pour un \Gryf ($y=1$) auquel le modèle accorde $0{,}1$, elle vaut $-0{,}9$ ; pour
le même élève, déjà classé à $0{,}99$, elle tombe à $-0{,}01$. La correction issue d'un élève correctement classé est donc
négligeable.
\end{resultat}
