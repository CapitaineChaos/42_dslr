...
\section{Étape 2 : du score à la probabilité}
...
\section{Étape 3 : le coût d'une prédiction}
...
symétriques. Les deux suivantes correspondent à $z=6$, donc $p=0{,}9975$. Cette
probabilité coûte $0{,}0025$ lorsqu'elle porte sur la réponse observée et
