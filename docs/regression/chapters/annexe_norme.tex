...
arbitraire. Le second, dit \emph{régularisation}, ajoute au coût un terme
$\frac{\mu}{2}\|w\|^2$ qui croît avec la norme. Relevée par une parabole, la courbe bleue de la figure~\ref{fig:deux-parts}
laisse alors réapparaître un minimum, même sur des données séparables, et le
paramètre $\mu$ fixe où il tombe. La bibliothèque \texttt{scikit-learn} l'applique par défaut, ce qui
