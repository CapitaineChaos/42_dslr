...
pente. Supposons-la strictement positive partout : la pente croît alors sur tout
l'intervalle, donc elle passe au plus une fois par zéro. Un seul point critique
existe, et c'est un minimum, la pente y passant du négatif au positif.

Une fonction dont la dérivée seconde reste positive ou nulle est dite
\emph{convexe}. Deux minimums séparés par un maximum local exigeraient que la
pente monte, redescende, puis remonte : sa dérivée changerait de signe, ce que la
convexité interdit.
...
Deux colonnes proportionnelles produisent exactement ce cas. Si
