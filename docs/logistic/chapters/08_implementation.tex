...
La remarque s'étend à softmax. Son dénominateur $S=\sum_r e^{z_r}$ prend la même
valeur pour les quatre classes, donc
\[
  \frac{e^{z_a}}{S}>\frac{e^{z_b}}{S}
  \iff e^{z_a}>e^{z_b}
  \iff z_a>z_b .
\]
Les trois quantités $z_k$, $\sigma(z_k)$ et $\mathrm{softmax}(z)_k$ désignent le
même argmax, pour tout jeu de scores. Sur les $1\,600$ lignes du fichier
