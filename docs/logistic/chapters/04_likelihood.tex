...
modèle aux étiquettes observées. Le sujet du projet écrit la même formule avec
$h_\theta(x^i)$ à la place de $p_i$ ; la section~\ref{sec:sujet} donne la
...
$(n+1)\times m$ et le vecteur des résidus probabilistes est de taille $m$. Le
sujet donne cette formule composante par composante ; la
section~\ref{sec:sujet} montre que les deux écritures effectuent le même calcul.
...
\begin{vigilance}[\rsymt{separation}{Séparation complète}]
